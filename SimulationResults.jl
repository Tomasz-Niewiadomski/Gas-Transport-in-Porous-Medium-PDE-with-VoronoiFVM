...
md"# Simulation Results 👨🏽‍💻 v3.3"

# ╔═╡ def4dcc4-52ef-483c-99f3-79a4bd473e1f
...
# ╔═╡ 2eb0d264-22fb-43f2-9e3c-37ab9a74c155
...
# ╔═╡ d3842ce2-cd3c-4b71-9db3-9ae2b6018c27
"""begin
	history_1d = history(system_1d)
	history_2d = history(system_2d)
end""" # Cool but useless I think;

# ╔═╡ 61a1eaa0-2cc0-4511-9bb1-a8c24b5b2c5f
"""
begin
	p_updates1 = scatter(
						1:1:length(history_1d.times), history_1d.updates, title ="Updates 1D" , legend = false, color = "#ccccff" ,
						xticks = (1:5:length(history_1d.times)),
						xlabel = "Time step", ylabel ="Update value", guidefontallign = :left, xrotation = 30, titlefontsize = 10
						)
	p_updates1 = plot!(1:length(history_1d.times),history_1d.updates, color = "#ccccff", guidefontsize = 7)

	p_updates2 = scatter(
						1:length(history_2d.times), history_2d.updates, title ="Updates 2D" , legend = false, color = "#ccccff" ,xticks = (1:5:length(history_2d.times)),  xlabel = "Time step", ylabel ="Update value", guidefontsize = 7, xrotation = 30, titlefontsize = 10
						)
	p_updates2 = plot!(1:length(history_2d.times),history_2d.updates, color = "#ccccff")

	p_updates = plot(p_updates1, p_updates2, layout = (2,1))
end""" #Attempt at plotting the updates but I think there's no point;

# ╔═╡ b76c2766-9eb0-4a78-a12b-907d7000e7e2
"""
begin
	plot_history_1d = plot(legend = false, title = "History 1D", yscale = :log, xrotation = 30)
	for i in 1:1:length(history_1d.times)
	plot_history_1d = scatter!(history_1d[i,:])
	plot_history_1d = plot!(history_1d[i,:])
	end
	
	plot_history_2d = plot(legend = false, title = "History 2D", yscale = :log, xrotation = 30)
	for i in 1:1:length(history_2d.times)
	plot_history_2d = plot!(history_2d[i,:])
	plot_history_2d = scatter!(history_2d[i,:])
	end
	
	plot(plot_history_1d, plot_history_2d, layout = (2,1))
end"""# Attempt at plotting the history, but I think there's no point;
...
begin
	...
	#p3 = plot(error_plot_vfvm_1d,error_plot_vfvm_12, layout = (2,1), dpi = 500)

	# savefig(p3, "error_voronoi_1d2d.png")

	plot(error_plot_vfvm_1d)
end
...
# ╔═╡ 7ff45045-1162-42d2-aad6-09a7ddaca6f1
md"## Comparison with DifferentialEquations.jl"

# ╔═╡ 41d969b6-b4c9-4330-ad3d-21c9aa71201e
...
# ╔═╡ c500fd95-5804-41dc-bf72-48967cd6fc54
md"### Solving the system"
